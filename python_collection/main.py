...
# 실행용임 => 반드시 main(프로그램의 start 스위치임)이 있어야함
...
if __name__=='__main__':
    ...
    # my_collections.test_list.list_sample.make_list1() # 원하는 함수 실행(호출,call)시 import한 모듈명.함수명()으로 실행함
...
# import my_collections.test_list.list_misson1 as ls3
# import my_collections.test_tuple.tuple_sample as ts
import my_collections.test_list.list_mission2 as ls4
