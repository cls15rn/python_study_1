...
age = input('나이를 입력하세요: ')
gender = input('성별을 남, 여로 입력하세요: ')
height = float(input('키를 입력하세요: '))
weight = float(input('몸무게를 입력하세요: '))

print(name, '은 ', age, '세 ', gender, '자이고, 키는 ', height, 'cm 몸무게는 ', weight, 'kg 입니다.',sep="")

print('{}은 {}세 {}자이고, 키는 {}cm 몸무게는 {}kg 입니다.'.format(name, age, gender, height, weight))
